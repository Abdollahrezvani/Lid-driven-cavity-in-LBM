...
!bounce-back
     !lower wall-barrier
  do x=40,80
     f_help(x,40,4)=f_help(x,40,2)
     f_help(x,40,7)=f_help(x,40,5)
     f_help(x,40,8)=f_help(x,40,6)
  end do

!lower wall barrier

do x=40,80
sum=g_help(x,40,0)+g_help(x,40,1)+g_help(x,40,2)+g_help(x,40,3)+g_help(x,40,5)+g_help(x,40,6)
g_help(x,40,4)=wi(4)/(wi(4)+wi(7)+wi(8))*(t_hot-sum)
g_help(x,40,7)=wi(7)/(wi(4)+wi(7)+wi(8))*(t_hot-sum)
g_help(x,40,8)=wi(8)/(wi(4)+wi(7)+wi(8))*(t_hot-sum)
end do
...
!bounce-back
     !left wall-barrier
  do y=40,80
     f_help(40,y,3)=f_help(40,y,1)
     f_help(40,y,6)=f_help(40,y,8)
     f_help(40,y,7)=f_help(40,y,5)
  end do

!left wall barrier

do y=40,80
sum=g_help(40,y,0)+g_help(40,y,1)+g_help(40,y,2)+g_help(40,y,4)+g_help(40,y,5)+g_help(40,y,8)
g_help(40,y,3)=wi(3)/(wi(3)+wi(6)+wi(7))*(t_hot-sum)
g_help(40,y,6)=wi(6)/(wi(3)+wi(6)+wi(7))*(t_hot-sum)
g_help(40,y,7)=wi(7)/(wi(3)+wi(6)+wi(7))*(t_hot-sum)
end do
