...
do x=0,nx-1
     ...
     f_help(x,0:x,2)=f_help(x,0:x,4)
     f_help(x,0:x,3)=f_help(x,0:x,1)
     f_help(x,0:x,6)=f_help(x,0:x,8)
     


sum=g_help(x,0:x,0)+g_help(x,0:x,1)+g_help(x,0:x,4)+g_help(x,0:x,5)+g_help(x,0:x,7)+g_help(x,0:x,8)
g_help(x,0:x,2)=wi(2)/(wi(2)+wi(3)+wi(6))*(t_hot-sum)
g_help(x,0:x,3)=wi(3)/(wi(2)+wi(3)+wi(6))*(t_hot-sum)
g_help(x,0:x,6)=wi(6)/(wi(2)+wi(3)+wi(6))*(t_hot-sum)
